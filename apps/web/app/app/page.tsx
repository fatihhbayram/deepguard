...
export default async function Home({
  ...
  // is no account. Since R8-T1 the workspace layout has already turned away a reader with no
  // session at all, so what is left for this check is the second case — a session the layout
  // accepted and the listing then refused — plus the narrowing that lets everything below
  // read `user` as present. Neither of the two is the access control: the API has already
  // refused the listing, and what the reader gets here is somewhere useful to go rather than
  // an empty page they cannot explain.
